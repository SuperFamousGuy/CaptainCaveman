...
- Project-specific conventions (put in your workspace instruction file — `.github/copilot-instructions.md`, `CLAUDE.md`, `AGENTS.md`, etc.)
...
**Critical for discovery:** Your future agent needs to FIND your skill
